...
public abstract class Bonus extends GameElement {
    ...
    public Bonus(String name, double speed, Bounds2D bounds, CanvasModel canvasModel, int hP, int hit) {
        super(name, speed, bounds, canvasModel, hP, hit);
    }

    public Bonus(String name, double speed, GameElement referenceElement, CanvasModel canvasModel, int hP, int hit) {
        super(name, speed, referenceElement, canvasModel, hP, hit);
    }

    public Bonus(String name, double speed, Bounds2D bounds, GameElement referenceElement, CanvasModel canvasModel, int hit, int hP) {
